...
export default function BaristaDashboard() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'in_progress':
        return <Coffee className="w-4 h-4" style={{ color: 'var(--highlight)' }} />;
      case 'ready':
      ...
      {filteredOrders.length === 0 && (
        <Card>
          <CardContent className="text-center py-8">
            ...
            <h3 className="text-lg font-medium">No drink orders found</h3>
            <p>Orders will appear here when customers place beverage items</p>
          </CardContent>
        </Card>
      )}
      </div>
