      ...
      {filteredOrders.length === 0 && (
        <Card>
          <CardContent className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-gray-500">No kitchen orders found</h3>
            <p className="text-gray-400">Orders will appear here when customers place food items</p>
          </CardContent>
        </Card>
      )}
      </div>
