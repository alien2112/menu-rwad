        ...
        <div className="space-y-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="admin-card rounded-xl p-6">
              ...
              <div className="h-4 w-full rounded animate-pulse mb-4" />
              <div className="admin-card rounded-lg p-3 mb-4">
                <div className="h-4 w-16 rounded animate-pulse mb-2" />
                <div className="grid grid-cols-2 gap-2">
                  {[...Array(4)].map((_, j) => (
                    <div key={j} className="h-3 w-24 rounded animate-pulse" />
                  ))}
                </div>
              </div>
              <div className="flex gap-2">
                <div className="h-8 w-24 rounded-lg animate-pulse" />
                <div className="h-8 w-28 rounded-lg animate-pulse" />
