/**
 * Basic Fake Data Generation Script
 * Generates essential test data without complex relationships
 */
...
async function generateBasicData() {
  console.log('🚀 Starting Basic Fake Data Generation...\n');
  ...
  try {
    ...
    console.log('📋 Generating Simple Orders...');
    ...
    console.log('\n🎉 Basic Fake Data Generation Complete!');
    ...
    console.error('❌ Error generating basic fake data:', error);
  } finally {
