...
const CONFIG = {
  ...
  REPO_OWNER: process.env.GITHUB_USERNAME || 'your_username',
  REPO_NAME: process.env.GITHUB_REPO || 'marakshv2',
  BRANCH: 'master'
};
...
async function uploadAllImages() {
  ...
  if (CONFIG.GITHUB_TOKEN === 'your_github_token_here') {
    ...
    console.error('   Option 1: Set environment variable: export GITHUB_TOKEN="your_token"');
    console.error('   Option 2: Edit this script and update CONFIG.GITHUB_TOKEN');
    console.error('   Option 3: Run: GITHUB_TOKEN="your_token" node scripts/upload-moroccan-images.js');
    return;
  }
  
  if (CONFIG.REPO_OWNER === 'your_username') {
    console.error('❌ Please set your GitHub username:');
    console.error('   Option 1: Set environment variable: export GITHUB_USERNAME="your_username"');
    console.error('   Option 2: Edit this script and update CONFIG.REPO_OWNER');
    console.error('   Option 3: Run: GITHUB_USERNAME="your_username" node scripts/upload-moroccan-images.js');
    return;
  }
  ...
  console.log(`🔑 Token: ${CONFIG.GITHUB_TOKEN.substring(0, 8)}...`);
