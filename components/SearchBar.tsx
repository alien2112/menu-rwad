      ...
      <div className="relative max-w-md mx-auto">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-12 py-3 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-[#C2914A] focus:border-transparent transition-all duration-300"
            dir="rtl"
          />
          {searchQuery && (
            <button
