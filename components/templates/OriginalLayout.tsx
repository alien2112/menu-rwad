...
export const OriginalLayout = ({ item, onAddToCart, viewMode = 'list' }: OriginalLayoutProps) => {
  ...
  if (viewMode === 'grid') {
    return (
      <>
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20 hover:bg-white/15 transition-all duration-300 flex flex-col h-full">
          {/* Image Section */}
          ...
          <div className="flex-1 flex flex-col">
            <h3 className="text-white font-bold text-base mb-1 leading-tight line-clamp-2">
              {item.name}
            </h3>

            {item.nameEn && (
              <p className="text-white/60 text-xs mb-2 line-clamp-1">{item.nameEn}</p>
            )}
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                <div className="bg-gradient-to-r from-[#C2914A] to-[#B8853F] text-white px-3 py-1.5 rounded-full shadow-lg">
              ...
              <button
                ...
                className="bg-gradient-to-r from-[#C2914A] to-[#B8853F] hover:from-[#B8853F] hover:to-[#A67939] text-white p-2 rounded-full font-bold transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-xl"
              >
