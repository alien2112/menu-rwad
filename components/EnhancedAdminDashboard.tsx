...
export default function EnhancedAdminDashboard() {
  ...
  const StatCard = ({ title, value, icon: Icon, color, trend }: {
    ...
    <motion.div
      ...
      whileTap={{ scale: 0.95 }}
      className="glass-effect rounded-lg border border-white/10 p-6"
        ...
        {showSettings && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative glass-effect border border-white/10 rounded-2xl w-full max-w-2xl mx-4 p-6"
            >
