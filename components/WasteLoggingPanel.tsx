    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">تسجيل الهدر</h1>
            <p>تسجيل وإدارة هدر المواد والمنتجات</p>
          </div>
        </div>
      ...
      <div className="admin-card rounded-2xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div>
            <label className="block text-sm mb-2">الفئة</label>
            <select
          ...
          <div>
            <label className="block text-sm mb-2">السبب</label>
            <select
          ...
          <div>
            <label className="block text-sm mb-2">من تاريخ</label>
            <input
              type="date"
          ...
          <div>
            <label className="block text-sm mb-2">إلى تاريخ</label>
            <input
              type="date"
      ...
      {/* Waste Logs Table */}
      <div className="admin-card rounded-2xl p-6">
        <h3 className="text-lg font-bold mb-4">سجلات الهدر</h3>
        
        {wasteLogs.length === 0 ? (
          <div className="text-center py-8">
            <Package className="w-16 h-16 mx-auto mb-4" />
            <p>لا توجد سجلات هدر</p>
          </div>
        ) : (
            ...
            <table className="w-full admin-table">
              <thead>
                <tr className="border-b">
                  <th className="text-right py-3">العنصر</th>
                  <th className="text-right py-3">الفئة</th>
                  <th className="text-right py-3">الكمية</th>
                  <th className="text-right py-3">التكلفة</th>
                  <th className="text-right py-3">السبب</th>
                  <th className="text-right py-3">القسم</th>
              ...
              <tbody>
                {wasteLogs.map((log) => (
                  <tr key={log._id} className="border-b">
                    ...
                    <td>{getReasonLabel(log.reason)}</td>
                    <td>{getDepartmentLabel(log.department)}</td>
                    <td>{formatDate(log.wasteDate)}</td>
                    <td className="py-3">
          ...
          <div className="admin-card rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm mb-2">اسم العنصر *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm mb-2">الوحدة *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm mb-2">التكلفة *</label>
                  <input
                    type="number"
                    min="0"
                    step="0.01"
                ...
                <div>
                  <label className="block text-sm mb-2">تاريخ الهدر</label>
                  <input
                    type="datetime-local"
              ...
              {formData.isRecoverable && (
                <div>
                  <label className="block text-sm mb-2">إجراء الاسترداد</label>
                  <input
                    type="text"
